import { useRef, useLayoutEffect, useContext, createContext, useMemo, useCallback, useState, useEffect, memo, forwardRef, useImperativeHandle } from 'react';
...
var css_248z$e = ".c1wupbe700-beta5{background-color:inherit;border-bottom:1px solid var(--border-color);border-right:1px solid var(--border-color);contain:strict;contain:size layout style paint;outline:none;overflow:hidden;overflow:clip;padding:0 8px;text-overflow:ellipsis;white-space:nowrap}.c1wupbe700-beta5[aria-selected=true]{box-shadow:inset 0 0 0 2px var(--selection-color)}.cd0kgiy700-beta5{position:sticky;z-index:1}.c1730fa4700-beta5{box-shadow:2px 0 5px -2px rgba(136,136,136,.3)}";
styleInject(css_248z$e,{"insertAt":"top"});

const cell = "c1wupbe700-beta5";
const cellClassname = `rdg-cell ${cell}`;
const cellFrozen = "cd0kgiy700-beta5";
const cellFrozenClassname = `rdg-cell-frozen ${cellFrozen}`;
const cellFrozenLast = "c1730fa4700-beta5";
const cellFrozenLastClassname = `rdg-cell-frozen-last ${cellFrozenLast}`;

var css_248z$d = ".r104f42s700-beta5{--color:#000;--border-color:#ddd;--summary-border-color:#aaa;--background-color:#fff;--header-background-color:#f9f9f9;--row-hover-background-color:#f5f5f5;--row-selected-background-color:#dbecfa;--row-selected-hover-background-color:#c9e3f8;--checkbox-color:#005194;--checkbox-focus-color:#61b8ff;--checkbox-disabled-border-color:#ccc;--checkbox-disabled-background-color:#ddd;--selection-color:#66afe9;--font-size:14px;content-visibility:auto;background-color:var(--background-color);border:1px solid var(--border-color);box-sizing:border-box;color:var(--color);color-scheme:var(--color-scheme,light dark);contain:strict;contain:size layout style paint;direction:ltr;font-size:var(--font-size);height:350px;overflow:auto;user-select:none}@supports not (contain:strict){.r104f42s700-beta5{position:relative;z-index:0}}.r104f42s700-beta5 *,.r104f42s700-beta5 :after,.r104f42s700-beta5 :before{box-sizing:inherit}.r104f42s700-beta5.rdg-dark{--color-scheme:dark;--color:#ddd;--border-color:#444;--summary-border-color:#555;--background-color:#212121;--header-background-color:#1b1b1b;--row-hover-background-color:#171717;--row-selected-background-color:#1a73bc;--row-selected-hover-background-color:#1768ab;--checkbox-color:#94cfff;--checkbox-focus-color:#c7e6ff;--checkbox-disabled-border-color:#000;--checkbox-disabled-background-color:#333}.r104f42s700-beta5.rdg-light{--color-scheme:light}@media (prefers-color-scheme:dark){.r104f42s700-beta5:not(.rdg-light){--color:#ddd;--border-color:#444;--summary-border-color:#555;--background-color:#212121;--header-background-color:#1b1b1b;--row-hover-background-color:#171717;--row-selected-background-color:#1a73bc;--row-selected-hover-background-color:#1768ab;--checkbox-color:#94cfff;--checkbox-focus-color:#c7e6ff;--checkbox-disabled-border-color:#000;--checkbox-disabled-background-color:#333}}.v7ly7s700-beta5.r1otpg64700-beta5{cursor:move}";
styleInject(css_248z$d,{"insertAt":"top"});

const root = "r104f42s700-beta5";
const rootClassname = `rdg ${root}`;
const viewportDragging = "v7ly7s700-beta5";
const viewportDraggingClassname = `rdg-viewport-dragging ${viewportDragging}`;

var css_248z$c = ".r1otpg64700-beta5{background-color:var(--background-color);contain:strict;contain:size layout style paint;display:grid;grid-template-columns:var(--template-columns);grid-template-rows:var(--row-height);height:var(--row-height);left:0;line-height:var(--row-height);position:absolute;width:var(--row-width)}.r1otpg64700-beta5:hover{background-color:var(--row-hover-background-color)}.r1otpg64700-beta5[aria-selected=true]{background-color:var(--row-selected-background-color)}.r1otpg64700-beta5[aria-selected=true]:hover{background-color:var(--row-selected-hover-background-color)}";
styleInject(css_248z$c,{"insertAt":"top"});

const row = "r1otpg64700-beta5";
...
var css_248z$b = ".c1w6d5eo700-beta5{align-items:center;cursor:pointer;display:flex;inset:0;justify-content:center;margin-right:1px;position:absolute}.c1h7iz8d700-beta5{all:unset;margin:0;width:0}.cc79ydj700-beta5{background-color:var(--background-color);border:2px solid var(--border-color);content:\"\";height:20px;width:20px}.c1h7iz8d700-beta5:checked+.cc79ydj700-beta5{background-color:var(--checkbox-color);box-shadow:inset 0 0 0 4px var(--background-color)}.c1h7iz8d700-beta5:focus+.cc79ydj700-beta5{border-color:var(--checkbox-focus-color)}.c1e5jt0b700-beta5{cursor:default}.c1e5jt0b700-beta5 .cc79ydj700-beta5{background-color:var(--checkbox-disabled-background-color);border-color:var(--checkbox-disabled-border-color)}";
styleInject(css_248z$b,{"insertAt":"top"});

const checkboxLabel = "c1w6d5eo700-beta5";
const checkboxLabelClassname = `rdg-checkbox-label ${checkboxLabel}`;
const checkboxInput = "c1h7iz8d700-beta5";
const checkboxInputClassname = `rdg-checkbox-input ${checkboxInput}`;
const checkbox = "cc79ydj700-beta5";
const checkboxClassname = `rdg-checkbox ${checkbox}`;
const checkboxLabelDisabled = "c1e5jt0b700-beta5";
...
var css_248z$a = ".gch972y700-beta5{outline:none}.cz2qf0d700-beta5{stroke:currentColor;stroke-width:1.5px;fill:transparent;margin-left:4px;vertical-align:middle}.cz2qf0d700-beta5>path{transition:d .1s}";
styleInject(css_248z$a,{"insertAt":"top"});

const groupCellContent = "gch972y700-beta5";
const groupCellContentClassname = `rdg-group-cell-content ${groupCellContent}`;
const caret = "cz2qf0d700-beta5";
...
var css_248z$9 = ".ram993v700-beta5{outline:none}.ram993v700-beta5:after{box-shadow:inset 0 0 0 2px var(--selection-color);content:\"\";inset:0;pointer-events:none;position:absolute;z-index:2}.ram993v700-beta5>.c1wupbe700-beta5:first-child{box-shadow:inset 2px 0 0 0 var(--selection-color)}";
styleInject(css_248z$9,{"insertAt":"top"});

const rowSelected = "ram993v700-beta5";
...
var css_248z$8 = ".h13yq3r8700-beta5{cursor:pointer;display:flex}.h13yq3r8700-beta5:focus{outline:none}.ht6rdyl700-beta5{flex-grow:1;overflow:hidden;overflow:clip;text-overflow:ellipsis}.a1emyi9700-beta5{fill:currentColor}.a1emyi9700-beta5>path{transition:d .1s}";
styleInject(css_248z$8,{"insertAt":"top"});

const headerSortCell = "h13yq3r8700-beta5";
const headerSortCellClassname = `rdg-header-sort-cell ${headerSortCell}`;
const headerSortName = "ht6rdyl700-beta5";
const headerSortNameClassname = `rdg-header-sort-name ${headerSortName}`;
const arrow = "a1emyi9700-beta5";
...
var css_248z$7 = ".celq7o9700-beta5{touch-action:none}.celq7o9700-beta5:after{bottom:0;content:\"\";cursor:col-resize;position:absolute;right:0;top:0;width:10px}";
styleInject(css_248z$7,{"insertAt":"top"});

const cellResizable = "celq7o9700-beta5";
...
var css_248z$6 = ".h197vzie700-beta5{background-color:var(--header-background-color);contain:strict;contain:size layout style paint;display:grid;font-weight:700;grid-template-columns:var(--template-columns);grid-template-rows:var(--header-row-height);height:var(--header-row-height);line-height:var(--header-row-height);outline:none;position:sticky;top:0;width:var(--row-width);z-index:3}.h197vzie700-beta5[aria-selected=true]{box-shadow:inset 0 0 0 2px var(--selection-color)}";
styleInject(css_248z$6,{"insertAt":"top"});

const headerRow = "h197vzie700-beta5";
...
var css_248z$5 = ".c1bmg16t700-beta5,.ccpfvsn700-beta5{background-color:#ccf}.c1bmg16t700-beta5.ccpfvsn700-beta5{background-color:#99f}";
styleInject(css_248z$5,{"insertAt":"top"});

const cellCopied = "ccpfvsn700-beta5";
const cellCopiedClassname = `rdg-cell-copied ${cellCopied}`;
const cellDraggedOver = "c1bmg16t700-beta5";
...
var css_248z$4 = ".gyxx7e9700-beta5:not([aria-selected=true]){background-color:var(--header-background-color)}.gyxx7e9700-beta5>.c1wupbe700-beta5:not(:last-child):not(.c1730fa4700-beta5){border-right:none}";
styleInject(css_248z$4,{"insertAt":"top"});

const groupRow = "gyxx7e9700-beta5";
...
var css_248z$3 = ".snfqesz700-beta5.r1otpg64700-beta5{grid-template-rows:var(--summary-row-height);height:var(--summary-row-height);line-height:var(--summary-row-height);position:sticky;z-index:3}.s1jijrjz700-beta5>.c1wupbe700-beta5{border-top:2px solid var(--summary-border-color)}";
styleInject(css_248z$3,{"insertAt":"top"});

const summaryRow = "snfqesz700-beta5";
const summaryRowBorderClassname = "s1jijrjz700-beta5";
...
var css_248z$2 = ".c1tngyp1700-beta5.rdg-cell{padding:0}";
styleInject(css_248z$2,{"insertAt":"top"});

const cellEditing = "c1tngyp1700-beta5";
function EditCell({
  column,
  colSpan,
  row,
  ...
  var _column$editorOptions, _column$editorOptions3;
  ...
  const className = getCellClassname(column, 'rdg-editor-container', typeof cellClass === 'function' ? cellClass(row) : cellClass, !((_column$editorOptions = column.editorOptions) != null && _column$editorOptions.createPortal) && cellEditing);
  let content;

  if (column.editor != null) {
    var _column$editorOptions2;
    ...
    if ((_column$editorOptions2 = column.editorOptions) != null && _column$editorOptions2.createPortal) {
      content = /*#__PURE__*/jsxs(Fragment, {
        children: [/*#__PURE__*/createPortal(content, editorPortalTarget), /*#__PURE__*/jsx(column.formatter, {
          column: column,
          row: row,
          isCellSelected: true,
          onRowChange: onRowChange
  ...
  return /*#__PURE__*/jsx("div", {
    ...
    className: className,
    style: getCellStyle(column, colSpan),
    onKeyDown: (_column$editorOptions3 = column.editorOptions) != null && _column$editorOptions3.createPortal ? handleKeyDown : undefined,
    onMouseDownCapture: cancelFrameRequest,
    children: content
  });
}

var css_248z$1 = ".cadd3bp700-beta5{background-color:var(--selection-color);bottom:0;cursor:move;height:8px;position:absolute;right:0;width:8px}.cadd3bp700-beta5:hover{background-color:var(--background-color);border:2px solid var(--selection-color);height:16px;width:16px}";
styleInject(css_248z$1,{"insertAt":"top"});

const cellDragHandle = "cadd3bp700-beta5";
...
function DataGrid({
  ...
  function handleKeyDown(event, isEditorPortalEvent = false) {
...
var css_248z = ".t16y9g8l700-beta5{appearance:none;background-color:var(--background-color);border:2px solid #ccc;box-sizing:border-box;color:var(--color);font-family:inherit;font-size:var(--font-size);height:100%;padding:0 6px;vertical-align:top;width:100%}.t16y9g8l700-beta5:focus{border-color:var(--selection-color);outline:none}.t16y9g8l700-beta5::placeholder{color:#999;opacity:1}";
styleInject(css_248z,{"insertAt":"top"});

const textEditor = "t16y9g8l700-beta5";
